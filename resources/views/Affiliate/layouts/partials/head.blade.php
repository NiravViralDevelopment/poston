<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('affiliate/assets/vendor/css/rtl/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('affiliate/assets/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="{{ asset('affiliate/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
